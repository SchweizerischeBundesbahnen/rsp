...
\subsection{Real-world Context}
        real-world context, show our synthetic assumptions which are violated in the real-world
        real-world operations: how is it solved today in the real world, by humans and algorithmic
        Hypothesis 1: show speed-up in at least one implementation
        Hypothesis 2: show some ideas, show why space and time
