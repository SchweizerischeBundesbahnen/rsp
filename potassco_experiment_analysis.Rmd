...
```{python}
experiment_base_directory = '../rsp-data/003_a_bit_more_advanced_schedules_only_2020_06_19T16_23_16_baseline_2020_07_15T17_14_34/'
...
#     print(experiment.experiment_id)
    for agent_id, topo in experiment.problem_delta_perfect_after_malfunction.topo_dict.items():
...
experiment_details = pd.DataFrame([exp_results_of_experiment_of_interest._asdict()],columns=['experiment_id','malfunction','size',
       ...
       'time_delta_perfect_after_malfunction','speed_up_lower_bound','nb_resource_conflicts_full',
...
experiment_details['choices_delta_perfect_reschedule'] = choices_delta_perfect_reschedule
