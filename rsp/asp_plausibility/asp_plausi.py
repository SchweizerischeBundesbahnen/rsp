...
def asp_plausi_analysis(
    ...
    for item in ['full', 'full_after_malfunction', 'delta_after_malfunction']:
        ...
        two_dimensional_scatter_plot(
            ...
            title='solver should spend most of the time solving: compare solve and total solver time for ' + item,
        ...
        two_dimensional_scatter_plot(
            ...
            title=f'solver should spend most of the time solving: comparison total solver time (b) and solve_time for {item}',
            output_folder=output_folder
        )
        ...
        two_dimensional_scatter_plot(
            ...
            title=f'propagation times should be low in comparison to solve times: '
        ...
        two_dimensional_scatter_plot(
            ...
            baseline_column='solve_time_' + item,
            title='propagation times should be low in comparison to solve times: '
        ...
        two_dimensional_scatter_plot(
            ...
            title=f'choice conflict ratio should be close to 1; '
        ...
        two_dimensional_scatter_plot(
            ...
            title=f'Choices represent the size of the solution space (how many routing alternatives, '
        ...
        two_dimensional_scatter_plot(
            ...
            title=f'Conflicts represent the number of routing alternatives and .\n'
        ...
        two_dimensional_scatter_plot(
            ...
            title=f'final optimization costs_{item} per experiment_id',
            output_folder=output_folder
        )
        two_dimensional_scatter_plot(
            data=data_frame,
            columns=['total_time_' + item, 'costs_' + item],
            title=f'Are solver times and optimization costs correlated? Final optimization costs_{item} per costs_{item}',
            output_folder=output_folder
        )
