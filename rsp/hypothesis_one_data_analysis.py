...
def render_experiment(experiment: ExperimentParameters, data_frame: DataFrame):
    ...
    assert rows['experiment_id'].iloc[0] == experiment.experiment_id, \
        f"experiment{experiment.experiment_id} different {data_frame['experiment_id'].iloc[0]}!={experiment.experiment_id}"
