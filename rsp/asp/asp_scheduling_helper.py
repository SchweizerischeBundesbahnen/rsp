...
def determine_delta(full_reschedule_trainrunwaypoints_dict: Dict[int, Trainrun],
    ...
    We can then (see :meth:`rsp.asp.asp_problem_description.ASPProblemDescription._translate_freeze_to_ASP`.)
    ...
    # Freeze are all train run way points in the re-schedule_static that not in the delta
    if verbose:
