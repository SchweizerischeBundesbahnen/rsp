...
if from_cache:
    ...
    local_filter_experiment_results_analysis_data_frame = partial(
        ...
        min_time_online_unrestricted=20,
...
```{python}
hypothesis_one_analysis_visualize_speed_up(experiment_data=experiment_data_filtered, nb_bins=10)
...
for prefix in ['solver_statistics_conflicts', 'solver_statistics_choices', 'nb_resource_conflicts']:
    columns_of_interest =[ f'{prefix}_{scope}' for scope in rescheduling_scopes_visualization ]
