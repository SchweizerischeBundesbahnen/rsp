...
items = {
    'problem_schedule': exp_results_of_experiment_of_interest.problem_schedule,
    'problem_online_unrestricted': exp_results_of_experiment_of_interest.problem_online_unrestricted,
    'problem_offline_delta': exp_results_of_experiment_of_interest.problem_offline_delta
}
...
```{python}
resource_occupations_reschedule = time_windows_as_resource_occupations_per_agent(problem=exp_results_of_experiment_of_interest.problem_online_unrestricted)
trajectories = trajectories_from_resource_occupations_per_agent(
    resource_occupations_schedule=resource_occupations_reschedule,
    plotting_information=plotting_data.plotting_information)
choices_online_unrestricted = exp_results_of_experiment_of_interest.results_online_unrestricted.solver_statistics["solving"]["solvers"]["choices"]
print("Number of choices the solver has to make was {}".format(choices_online_unrestricted))
plot_time_resource_trajectories(trajectories=trajectories,
...
```{python}
resource_occupations_offline_delta = time_windows_as_resource_occupations_per_agent(problem=exp_results_of_experiment_of_interest.problem_offline_delta)
trajectories = trajectories_from_resource_occupations_per_agent(
    resource_occupations_schedule=resource_occupations_offline_delta,
    plotting_information=plotting_data.plotting_information)
choices_offline_delta = exp_results_of_experiment_of_interest.results_offline_delta.solver_statistics["solving"]["solvers"]["choices"]
print("Number of choices the solver has to make was {}".format(choices_offline_delta))
plot_time_resource_trajectories(trajectories=trajectories,
...
```{python}
resource_occupations_delta_naive_reschedule = time_windows_as_resource_occupations_per_agent(problem=exp_results_of_experiment_of_interest.problem_online_route_restricted)
trajectories = trajectories_from_resource_occupations_per_agent(
    resource_occupations_schedule=resource_occupations_delta_naive_reschedule,
    plotting_information=plotting_data.plotting_information)
choices_delta_naive_reschedule = exp_results_of_experiment_of_interest.results_online_route_restricted.solver_statistics["solving"]["solvers"]["choices"]
...
```{python}
resource_occupations_delta_online_reschedule = time_windows_as_resource_occupations_per_agent(problem=exp_results_of_experiment_of_interest.problem_online_transmission_chains_fully_restricted)
trajectories = trajectories_from_resource_occupations_per_agent(
    resource_occupations_schedule=resource_occupations_delta_online_reschedule,
    plotting_information=plotting_data.plotting_information)
choices_delta_online_reschedule = exp_results_of_experiment_of_interest.results_online_transmission_chains_fully_restricted.solver_statistics["solving"]["solvers"]["choices"]
...
print("=================================================================================")
print(f"= {experiment_base_directory} results_online_unrestricted ")
print("=================================================================================")
_print_stats(exp_results_of_experiment_of_interest.results_online_unrestricted.solver_statistics)
print("=================================================================================")
print(f"= {experiment_base_directory} results_offline_delta ")
print("=================================================================================")
_print_stats(exp_results_of_experiment_of_interest.results_offline_delta.solver_statistics)
```
