...
experiment_data = pd.DataFrame(
    ...
    columns=['experiment_id','malfunction','size', 'size_used_online_unrestricted',
            'n_agents', 'max_num_cities', 'max_rail_between_cities',
            'max_rail_in_city', 'time_schedule', 'time_online_unrestricted',
            'time_offline_delta',
            'speed_up_lower_bound',
            'nb_resource_conflicts_schedule',
            'nb_resource_conflicts_online_unrestricted',
            'nb_resource_conflicts_offline_delta',
            'costs_schedule',
            'solve_total_ratio_schedule',
            'solve_time_schedule',
            'choice_conflict_ratio_schedule',
            'choices_schedule',
            'conflicts_schedule',
            'user_accu_propagations_schedule',
            'user_step_propagations_schedule',
            'costs_online_unrestricted',
            'solve_total_ratio_online_unrestricted',
            'solve_time_online_unrestricted',
            'choice_conflict_ratio_online_unrestricted',
            'choices_online_unrestricted',
            'conflicts_online_unrestricted',
            'user_accu_propagations_online_unrestricted',
            'user_step_propagations_online_unrestricted',
            'costs_offline_delta',
            'solve_total_ratio_offline_delta',
            'solve_time_offline_delta',
            'choice_conflict_ratio_offline_delta',
            'choices_offline_delta',
            'conflicts_offline_delta',
            'user_accu_propagations_offline_delta',
            'user_step_propagations_offline_delta'])
...
columns_of_interest = ['time_schedule','time_online_unrestricted','time_offline_delta']
```
