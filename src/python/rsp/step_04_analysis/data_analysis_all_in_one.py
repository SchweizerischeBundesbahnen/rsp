...
from rsp.step_04_analysis.compute_time_analysis.asp_plausi import visualize_hypotheses_asp
...
from rsp.step_04_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_resource_time_diagrams
...
from rsp.step_04_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_time_window_resource_trajectories
...
from rsp.step_04_analysis.experiment_render_utils import visualize_experiment
...
def hypothesis_one_data_analysis(
    ...
    if analysis_2d:
        ...
        visualize_hypotheses_asp(experiment_data=experiment_data, output_folder=results_folder)
    ...
    if qualitative_analysis_experiment_ids:
        ...
        for experiment_result in experiment_results_list:
            ...
            plot_time_window_resource_trajectories(
                experiment_result=experiment_result, schedule_plotting=schedule_plotting, output_folder=output_folder_of_interest
            )
            plot_shared_heatmap(schedule_plotting=schedule_plotting, experiment_result=experiment_result, output_folder=output_folder_of_interest)
            plot_resource_time_diagrams(schedule_plotting=schedule_plotting, with_diff=True, output_folder=output_folder_of_interest)
