...
from rsp.resource_occupation.resource_occupation import extract_time_windows
from rsp.resource_occupation.resource_occupation import LeftClosedInterval
