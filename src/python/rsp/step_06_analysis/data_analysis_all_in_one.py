...
from rsp.resource_occupation.resource_occupation import extract_resource_occupations_for_all_scopes
...
from rsp.step_06_analysis.compute_time_analysis.asp_plausi import visualize_asp_problem_reduction
from rsp.step_06_analysis.compute_time_analysis.asp_plausi import visualize_asp_solver_stats
from rsp.step_06_analysis.compute_time_analysis.compute_time_analysis import hypothesis_one_analysis_prediction_quality
from rsp.step_06_analysis.compute_time_analysis.compute_time_analysis import hypothesis_one_analysis_visualize_changed_agents
...
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_histogram_from_delay_data
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_nb_route_alternatives
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_resource_occupation_heat_map
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_route_dag
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_shared_heatmap
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_time_density
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_time_resource_trajectories
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_time_resource_trajectories_all_scopes
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_time_window_sizes
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_time_windows_all_scopes
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import plot_train_paths
from rsp.step_06_analysis.detailed_experiment_analysis.detailed_experiment_analysis import print_path_stats
from rsp.step_06_analysis.detailed_experiment_analysis.resources_plotting_information import extract_plotting_information
from rsp.step_06_analysis.detailed_experiment_analysis.resources_plotting_information import PlottingInformation
from rsp.step_06_analysis.detailed_experiment_analysis.route_dag_analysis import visualize_route_dag_constraints
...
from rsp.step_06_analysis.detailed_experiment_analysis.trajectories import extract_trajectories_for_all_scopes
from rsp.step_06_analysis.detailed_experiment_analysis.trajectories import get_difference_in_time_space_trajectories
from rsp.step_06_analysis.detailed_experiment_analysis.trajectories import trajectories_from_resource_occupations_per_agent
from rsp.step_06_analysis.malfunction_analysis.disturbance_propagation import compute_disturbance_propagation_graph
from rsp.step_06_analysis.malfunction_analysis.disturbance_propagation import plot_delay_propagation_graph
from rsp.step_06_analysis.malfunction_analysis.disturbance_propagation import resource_occpuation_from_transmission_chains
from rsp.step_06_analysis.malfunction_analysis.malfunction_analysis import plot_delay_propagation_2d
from rsp.step_06_analysis.malfunction_analysis.malfunction_analysis import plot_lateness
from rsp.step_06_analysis.malfunction_analysis.malfunction_analysis import print_situation_overview
from rsp.transmission_chains.transmission_chains import extract_transmission_chains_from_schedule
from rsp.utils.file_utils import check_create_folder


def hypothesis_one_data_analysis(experiment_output_directory: str, qualitative_analysis_experiment_ids: List[int] = None, save_as_tsv: bool = False):
    """
...
if __name__ == "__main__":
    hypothesis_one_data_analysis(experiment_output_directory=BASELINE_DATA_FOLDER)
