...
# file handler
def add_file_handler_to_rsp_logger(file_name: str, log_level=logging.INFO) -> logging.FileHandler:
...
def remove_file_handler_from_rsp_logger(fh: logging.FileHandler):
    fh.close()
    rsp_logger.removeHandler(fh)
