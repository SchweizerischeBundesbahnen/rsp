...
if __name__ == '__main__':
    # sample call:
    # python src.python.rsp/asp_plausibility/potassco_solution_checker \
    #   --experiment_data_folder_name=../src.python.rsp-data/agent_0_malfunction_2020_05_27T19_45_49/data --experiment_id=0 --problem=full_after_malfunction
    parser = argparse.ArgumentParser()
    parser.add_argument('--experiment_data_folder_name', type=str, nargs=1, help='../src.python.rsp-data/agent_0_malfunction_2020_05_27T19_45_49/data')
