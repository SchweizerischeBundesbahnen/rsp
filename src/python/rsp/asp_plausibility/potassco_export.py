...
def potassco_export(experiment_potassco_directory: str,
    ...
    for file in schedule_programs + reschedule_programs:
        with path('rsp_encodings', file) as src:
...
if __name__ == '__main__':
    # sample call:
    # python src.python.rsp/asp_plausibility/potassco_export.py --experiment_base_directory=../src.python.rsp-data/agent_0_malfunction_2020_05_27T19_45_49
    #   --experiment_id=0 --problem=full_after_malfunction
    parser = argparse.ArgumentParser()
    parser.add_argument('--experiment_base_directory', type=str, nargs=1, help='../src.python.rsp-data/agent_0_malfunction_2020_05_27T19_45_49')
