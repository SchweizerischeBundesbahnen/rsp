...
```{python}
resource_occupations_delta_reschedule = time_windows_as_resource_occupations_per_agent(problem=exp_results_of_experiment_of_interest.problem_delta_perfect_after_malfunction)
trajectories = trajectories_from_resource_occupations_per_agent(
