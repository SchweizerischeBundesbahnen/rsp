...
display(experiment_data_filtered['lateness_full_after_malfunction'])
```
...
```{python}
display((experiment_data_filtered['costs_delta_online_after_malfunction']>experiment_data_filtered['costs_full_after_malfunction']).sum())
```
