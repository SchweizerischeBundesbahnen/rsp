...
from rsp.utils.data_types import convert_list_of_experiment_results_analysis_to_data_frame, convert_data_frame_row_to_experiment_results
...
```{python}
experiment_base_directory = './rsp/exp_hypothesis_one_2020_04_06T15_58_44/'
...
```{python}
single_experiment_dataframe = experiment_data.loc[experiment_data['experiment_id'] == experiment_of_interest]
single_exp_results = convert_data_frame_row_to_experiment_results(single_experiment_dataframe)
