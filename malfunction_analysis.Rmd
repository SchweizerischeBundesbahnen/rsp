...
```{python}
from rsp.hypothesis_two_encounter_graph import extract_transmission_chains_time_window,plot_transmission_chains_time_window
...
```{python}
transmission_chains_time_window = extract_transmission_chains_time_window(experiment_result=exp_results_of_experiment_of_interest)
```
